...
# Title: Promedios de tiempo
# Author: Daniel_Brandon
...
class Practica1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Promedios de tiempo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Promedios de tiempo")
