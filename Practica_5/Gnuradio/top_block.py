...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 500000, 1, 0, 0)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
